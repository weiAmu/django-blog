# Generated by Django 2.0 on 2020-06-03 02:15
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('body', DjangoUeditor.models.UEditorField(blank=True, verbose_name='文章内容')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('index', models.IntegerField(default=9, unique=True, verbose_name='大分类排序')),
            ],
            options={
                'verbose_name': '文章大分类',
                'verbose_name_plural': '文章大分类',
            },
        ),
        migrations.CreateModel(
            name='Category',
            fields=[
                ...
                ('index', models.IntegerField(default=99, unique=True, verbose_name='文章排序')),
                ('bigcategory', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='blog.BigCategory', verbose_name='文章大分类')),
            ],
            options={
                'verbose_name': '文章分类',
